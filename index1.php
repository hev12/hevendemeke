...
<body>
<div class="main" style="background:#045c09;">
		 <h1 style="text-align: center;
  margin-bottom: 0rem;
  font-family: 'Lora', serif;"><img src="./assets/images/logo/logo.jpg"   height="100" style="text-align: center;
  "></h1>

		 <h1 style="text-align: center;
  margin-bottom: 0rem;
  font-family: 'Lora', serif;  "> Queen's Registration</h1>
	 <div class="sap_tabs"style="background-color:#2c2e2c;">	
			...
			<div class="resp-tabs-container">
					...
					<div class="facts" style="background-color:#2c2e2c;">
